var content='<div class="ui-page" deviceName="iPhone6" deviceType="mobile" deviceWidth="375" deviceHeight="667">\
    ...
    <div id="alignmentBox">\
        ...
        <div id="s-Paragraph_16" class="pie richtext firer ie-background commentable pin vpin-beginning hpin-center non-processed-pin non-processed"   datasizewidth="133px" datasizeheight="22px" dataX="0" dataY="54" >\
          ...
          <div class="paddingLayer">\
            <div class="clipping">\
              <div class="content">\
                <div class="valign">\
                  <span id="rtr-s-Paragraph_16_0">วิธี</span><span id="rtr-s-Paragraph_16_1">การทดสอบ</span>\
                </div>\
              </div>\
            </div>\
          </div>\
        </div>\
        <div id="s-Image_27" class="pie image firer ie-background commentable pin vpin-beginning hpin-beginning non-processed-pin non-processed"   datasizewidth="13px" datasizeheight="21px" dataX="12" dataY="55"   alt="image" systemName="./images/f9e79c4e-4799-41cf-a88e-8ceab70c2e6a.svg" overlay="#007AFF">\
      ...
      <div id="s-statusBar" class="group firer ie-background commentable non-processed" datasizewidth="335px" datasizeheight="22px" dataX="30" dataY="9" >\
        ...
        <div id="s-Image_17" class="pie image firer ie-background commentable pin vpin-beginning hpin-end non-processed-pin non-processed"   datasizewidth="17px" datasizeheight="12px" dataX="63" dataY="12"   alt="image" systemName="./images/fef1630b-d228-4f14-8e82-cd4a3ae50463.svg" overlay="#000000">\
            <?xml version="1.0" encoding="UTF-8"?>\
        ...
        <div id="s-Image_18" class="pie image firer ie-background commentable pin vpin-beginning hpin-end non-processed-pin non-processed"   datasizewidth="18px" datasizeheight="18px" dataX="40" dataY="9"   alt="image" systemName="./images/7d486952-d864-4c6e-8ada-a1816939cfd0.svg" overlay="#000000">\
        ...
        <div id="s-Image_4" class="pie image firer ie-background commentable pin vpin-beginning hpin-end non-processed-pin non-processed"   datasizewidth="25px" datasizeheight="12px" dataX="10" dataY="14"   alt="image" systemName="./images/e7b242bd-4b9c-48ef-b80f-f6da52516153.svg" overlay="#000000">\
            <?xml version="1.0" encoding="UTF-8"?>\
      ...
      <div id="s-Text_1" class="pie label singleline autofit firer ie-background commentable non-processed"   datasizewidth="206px" datasizeheight="25px" dataX="85" dataY="111" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Text_1_0">กรุณาเลือกชนิดการทดสอบ</span></div></div></div></div>\
      <div id="s-Text_3" class="pie label singleline autofit firer ie-background commentable non-processed"   datasizewidth="144px" datasizeheight="25px" dataX="116" dataY="152" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Text_3_0">เพื่อเริ่มการทดสอบ</span></div></div></div></div>\
      <div id="s-Button" class="pie percentage label singleline firer click commentable pin hpin-center non-processed-percentage non-processed-pin non-processed"   datasizewidth="95%" datasizeheight="57px" dataX="0" dataY="206" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Button_0">Pure Tone Audio Meter</span></div></div></div></div>\
      <div id="s-Button_1" class="pie percentage label singleline firer click commentable pin hpin-center non-processed-percentage non-processed-pin non-processed"   datasizewidth="95%" datasizeheight="57px" dataX="0" dataY="282" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Button_1_0">Speech In Noise</span></div></div></div></div>\
      <div id="s-Button_2" class="pie percentage label singleline firer click commentable pin hpin-center non-processed-percentage non-processed-pin non-processed"   datasizewidth="95%" datasizeheight="57px" dataX="0" dataY="567" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Button_2_0">คู่มือ</span></div></div></div></div>\
\
      </div>\
      <div id="loadMark"></div>\
    </div>  \
