var content='<div class="ui-page" deviceName="iPhone6" deviceType="mobile" deviceWidth="375" deviceHeight="667">\
    ...
    <div id="alignmentBox">\
      ...
      <div id="s-button-forward" class="group firer ie-background commentable non-processed" datasizewidth="65px" datasizeheight="22px" dataX="304" dataY="57" >\
        ...
        <div id="s-Image_1" class="pie image firer click ie-background commentable non-processed"   datasizewidth="22px" datasizeheight="22px" dataX="43" dataY="0"   alt="image" systemName="./images/cdec2339-2fa2-4bae-9a4a-c895aa3faf8a.svg" overlay="#157EFB">\
