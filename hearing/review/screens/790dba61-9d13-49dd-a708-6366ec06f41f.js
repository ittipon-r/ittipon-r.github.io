var content='<div class="ui-page" deviceName="iPhone6" deviceType="mobile" deviceWidth="375" deviceHeight="667">\
    ...
    <div id="s-790dba61-9d13-49dd-a708-6366ec06f41f" class="screen growth-vertical devMobile devIOS canvas PORTRAIT firer ie-background commentable non-processed" alignment="left" name="Headset" width="375" height="667">\
    <div id="backgroundBox"></div>\
    <div id="alignmentBox">\
      <link type="text/css" rel="stylesheet" href="./resources/screens/790dba61-9d13-49dd-a708-6366ec06f41f-1592358931877.css" />\
      <!--[if IE]><link type="text/css" rel="stylesheet" href="./resources/screens/790dba61-9d13-49dd-a708-6366ec06f41f-1592358931877-ie.css" /><![endif]-->\
      <!--[if lte IE 8]><link type="text/css" rel="stylesheet" href="./resources/screens/790dba61-9d13-49dd-a708-6366ec06f41f-1592358931877-ie8.css" /><![endif]-->\
        ...
        <div id="s-Paragraph_16" class="pie richtext firer ie-background commentable pin vpin-beginning hpin-center non-processed-pin non-processed"   datasizewidth="133px" datasizeheight="22px" dataX="0" dataY="54" >\
          ...
          <div class="paddingLayer">\
            <div class="clipping">\
              <div class="content">\
                <div class="valign">\
                  <span id="rtr-s-Paragraph_16_0">Headset</span>\
                </div>\
              </div>\
            </div>\
          </div>\
        </div>\
        <div id="s-Image_27" class="pie image firer ie-background commentable pin vpin-beginning hpin-beginning non-processed-pin non-processed"   datasizewidth="13px" datasizeheight="21px" dataX="12" dataY="55"   alt="image" systemName="./images/195e72e2-3984-4951-b8ee-dec7ecc09772.svg" overlay="#007AFF">\
      ...
      <div id="s-statusBar" class="group firer ie-background commentable non-processed" datasizewidth="335px" datasizeheight="22px" dataX="30" dataY="9" >\
        ...
        <div id="s-Image_17" class="pie image firer ie-background commentable pin vpin-beginning hpin-end non-processed-pin non-processed"   datasizewidth="17px" datasizeheight="12px" dataX="63" dataY="12"   alt="image" systemName="./images/f07ed26b-44fe-489e-b1ee-2b51b51df13c.svg" overlay="#000000">\
            <?xml version="1.0" encoding="UTF-8"?>\
        ...
        <div id="s-Image_18" class="pie image firer ie-background commentable pin vpin-beginning hpin-end non-processed-pin non-processed"   datasizewidth="18px" datasizeheight="18px" dataX="40" dataY="9"   alt="image" systemName="./images/bf312006-b4fb-4a72-99a4-6ed7417cf766.svg" overlay="#000000">\
        ...
        <div id="s-Image_4" class="pie image firer ie-background commentable pin vpin-beginning hpin-end non-processed-pin non-processed"   datasizewidth="25px" datasizeheight="12px" dataX="10" dataY="14"   alt="image" systemName="./images/762b6703-bf5f-411d-9ee3-74b5d419c357.svg" overlay="#000000">\
            <?xml version="1.0" encoding="UTF-8"?>\
      ...
      <div id="s-Category_1" class="pie radiobuttonlist firer commentable non-processed"    datasizewidth="318px" datasizeheight="198px" dataX="29" dataY="148"  tabindex="-1">\
        <div class="backgroundLayer"></div>\
        <div class="scroll">\
          <table class="collapse" style="height: 100%; width: 100%;" summary="">\
            <tbody>\
                <tr>\
                  <td>\
                      <div class="radiobutton inputIOS" name="s-Category_1"   tabindex="-1" /><span class="option">ลำโพงจากโทรศัพท์โดยตรง</span>\
                  </td>\
                </tr>\
                <tr>\
                  <td>\
                      <div class="radiobutton inputIOS" name="s-Category_1"   tabindex="-1" /><span class="option">ต่อหูฟัง</span>\
                  </td>\
                </tr>\
                <tr>\
                  <td>\
                      <div class="radiobutton inputIOS" name="s-Category_1"   tabindex="-1" /><span class="option">ไม่แน่ใจ</span>\
                  </td>\
                </tr>\
            </tbody>\
          </table>\
      ...
      <div id="s-Text_1" class="pie label singleline autofit firer ie-background commentable non-processed"   datasizewidth="296px" datasizeheight="25px" dataX="30" dataY="112" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Text_1_0">กรุณาเลือกลำโพงที่จะใช้ในการทดสอบ</span></div></div></div></div>\
      <div id="s-Text_3" class="pie label singleline autofit firer ie-background commentable non-processed"   datasizewidth="297px" datasizeheight="25px" dataX="30" dataY="353" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Text_3_0">กรุณาเลือกชนิดยี่ห้อหรือโมเดลของหูฟัง</span></div></div></div></div>\
      <div id="s-Category_2" class="inputIOS nativedropdown firer ie-background commentable non-processed"    datasizewidth="180px" datasizeheight="28px" dataX="98" dataY="395"  tabindex="-1"><div class="backgroundLayer"><div class="icon"></div></div><div class="valign"><div class="value"></div></div><select id="s-Category_2-options" class="s-790dba61-9d13-49dd-a708-6366ec06f41f dropdown-options" ><option selected="selected" class="option"><br /></option>\
      <option  class="option">AirPods</option>\
      <option  class="option">Beats</option>\
      <option  class="option">Sony</option>\
      <option  class="option">ไม่ทราบ</option></select></div>\
      <div id="s-Button" class="pie percentage label singleline firer click commentable pin hpin-center non-processed-percentage non-processed-pin non-processed"   datasizewidth="95%" datasizeheight="57px" dataX="1" dataY="454" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Button_0">ถัดไป</span></div></div></div></div>\
\
      </div>\
      <div id="loadMark"></div>\
    </div>  \
