var content='<div class="ui-page" deviceName="iPhone6" deviceType="mobile" deviceWidth="375" deviceHeight="667">\
    ...
    <div id="s-0b206888-e45c-47e9-859c-6a4fc4ffd780" class="screen growth-vertical devMobile devIOS canvas PORTRAIT firer ie-background commentable non-processed" alignment="left" name="Guest" width="375" height="667">\
    <div id="backgroundBox"></div>\
    <div id="alignmentBox">\
      <link type="text/css" rel="stylesheet" href="./resources/screens/0b206888-e45c-47e9-859c-6a4fc4ffd780-1592358931877.css" />\
      <!--[if IE]><link type="text/css" rel="stylesheet" href="./resources/screens/0b206888-e45c-47e9-859c-6a4fc4ffd780-1592358931877-ie.css" /><![endif]-->\
      <!--[if lte IE 8]><link type="text/css" rel="stylesheet" href="./resources/screens/0b206888-e45c-47e9-859c-6a4fc4ffd780-1592358931877-ie8.css" /><![endif]-->\
        ...
        <div id="s-Paragraph_16" class="pie richtext firer ie-background commentable pin vpin-beginning hpin-center non-processed-pin non-processed"   datasizewidth="133px" datasizeheight="22px" dataX="0" dataY="54" >\
          ...
          <div class="paddingLayer">\
            <div class="clipping">\
              <div class="content">\
                <div class="valign">\
                  <span id="rtr-s-Paragraph_16_0">Login as Guest</span>\
                </div>\
              </div>\
            </div>\
          </div>\
        </div>\
        <div id="s-Image_27" class="pie image firer ie-background commentable pin vpin-beginning hpin-beginning non-processed-pin non-processed"   datasizewidth="13px" datasizeheight="21px" dataX="12" dataY="55"   alt="image" systemName="./images/3ff24d9f-b217-4fa9-b931-1d61645cd5b4.svg" overlay="#007AFF">\
      ...
      <div id="s-statusBar" class="group firer ie-background commentable non-processed" datasizewidth="335px" datasizeheight="22px" dataX="30" dataY="9" >\
        ...
        <div id="s-Image_17" class="pie image firer ie-background commentable pin vpin-beginning hpin-end non-processed-pin non-processed"   datasizewidth="17px" datasizeheight="12px" dataX="63" dataY="12"   alt="image" systemName="./images/b68beaa7-756d-459b-8392-dfceb628320c.svg" overlay="#000000">\
            <?xml version="1.0" encoding="UTF-8"?>\
        ...
        <div id="s-Image_18" class="pie image firer ie-background commentable pin vpin-beginning hpin-end non-processed-pin non-processed"   datasizewidth="18px" datasizeheight="18px" dataX="40" dataY="9"   alt="image" systemName="./images/6cc280f7-02af-4d1b-8072-7e3476746f1b.svg" overlay="#000000">\
        ...
        <div id="s-Image_4" class="pie image firer ie-background commentable pin vpin-beginning hpin-end non-processed-pin non-processed"   datasizewidth="25px" datasizeheight="12px" dataX="10" dataY="14"   alt="image" systemName="./images/9e506c57-0cff-47ca-bc16-6bbdc35625a6.svg" overlay="#000000">\
            <?xml version="1.0" encoding="UTF-8"?>\
      ...
      <div id="s-Text_4" class="pie label singleline autofit firer ie-background commentable non-processed"   datasizewidth="36px" datasizeheight="25px" dataX="23" dataY="129" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Text_4_0">เพศ</span><span id="rtr-s-Text_4_1">:</span></div></div></div></div>\
      <div id="s-Category_1" class="inputIOS nativedropdown firer ie-background commentable non-processed"    datasizewidth="180px" datasizeheight="28px" dataX="98" dataY="128"  tabindex="-1"><div class="backgroundLayer"><div class="icon"></div></div><div class="valign"><div class="value"></div></div><select id="s-Category_1-options" class="s-0b206888-e45c-47e9-859c-6a4fc4ffd780 dropdown-options" ><option selected="selected" class="option"><br /></option>\
      <option  class="option">ชาย</option>\
      <option  class="option">หญิง</option></select></div>\
      <div id="s-Text_5" class="pie label singleline autofit firer ie-background commentable non-processed"   datasizewidth="66px" datasizeheight="25px" dataX="23" dataY="179" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Text_5_0">ช่วงอายุ:</span></div></div></div></div>\
      <div id="s-Category_2" class="inputIOS nativedropdown firer ie-background commentable non-processed"    datasizewidth="180px" datasizeheight="28px" dataX="98" dataY="178"  tabindex="-1"><div class="backgroundLayer"><div class="icon"></div></div><div class="valign"><div class="value"></div></div><select id="s-Category_2-options" class="s-0b206888-e45c-47e9-859c-6a4fc4ffd780 dropdown-options" ><option selected="selected" class="option"><br /></option>\
      ...
      <div id="s-Text_6" class="pie label singleline autofit firer ie-background commentable non-processed"   datasizewidth="250px" datasizeheight="25px" dataX="23" dataY="226" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Text_6_0">อาชีพเกี่ยวข้องกับเสียงดังหรือไม่:</span></div></div></div></div>\
      <div id="s-Button" class="pie percentage label singleline firer click commentable pin hpin-center non-processed-percentage non-processed-pin non-processed"   datasizewidth="95%" datasizeheight="57px" dataX="0" dataY="320" ><div class="backgroundLayer"></div><div class="paddingLayer"><div class="content"><div class="valign"><span id="rtr-s-Button_0">ถัดไป</span></div></div></div></div>\
      <div id="s-Category_3" class="inputIOS nativedropdown firer ie-background commentable non-processed"    datasizewidth="180px" datasizeheight="28px" dataX="97" dataY="265"  tabindex="-1"><div class="backgroundLayer"><div class="icon"></div></div><div class="valign"><div class="value"></div></div><select id="s-Category_3-options" class="s-0b206888-e45c-47e9-859c-6a4fc4ffd780 dropdown-options" ><option selected="selected" class="option"><br /></option>\
      <option  class="option">ใช่</option>\
      <option  class="option">ไม่ใช่</option></select></div>\
\
      </div>\
      <div id="loadMark"></div>\
    </div>  \
